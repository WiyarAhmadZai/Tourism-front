...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8 px-4 md:px-40">
      <div className="layout-content-container flex flex-col max-w-[1200px] mx-auto w-full">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">About Us</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">Careers</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">Blog</a>
          </div>
          
          <div className="flex flex-col gap-3">
            <h4 className="text-slate-900 dark:text-white font-bold mb-1">Support</h4>
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">Contact Us</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">FAQ</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm hover:text-primary" href="#">Terms of Service</a>
          </div>
          
          <div className="flex flex-col gap-3">
            <h4 className="text-slate-900 dark:text-white font-bold mb-1">Follow Us</h4>
